export const data = [
    ...
    {
        id: 34, keyword: '外包', sentence: "Set and enforce an aspirational personal hourly rate. If fixing a problem will save less than your hourly rate, ignore it.",
        chinese: '设定并执行一个理想的个人小时工资。如果解决一个问题将会比你的小时工资少，忽视它。'
    },
    {
        id: '34-1', keyword: '外包', sentence: "If outsourcing a task will cost less than your hourly rate, outsource it.",
        chinese: '如果外包一项任务将会比你的小时工资少，外包它。'
    },
    {
