export const data = [
    ...
    },
    {
        ...
        chinese: '常规框架：努力的任务太大太可怕，我甚至无法开始。重构框架：我能做的最小的一件事是什么，可以让我朝正确方向前进？'
    },
    {
        id: 're-s-5',
        keyword: '目标',
    ...
    },
    {
        ...
        chinese: '常规框架：无论经理做什么都是管理。重构框架：如果你不进行衡量，那你就没有在管理。'
    },
    {
        id: 're-s-12',
        keyword: '创作',
        ...
        chinese: '常规框架：对你创作的赞美预示着你会有一个成功。重构框架：只有行动才能预测成功，而不是语言。注意别人是否会扩展或修改你的创作。'
    },
    {
        id: 're-s-13',
        keyword: '写作环境',
        sentence: 'Usual Frame: I can\'t think of anything to write. Reframe: I\'m in the wrong environment for writing.',
        chinese: '常规框架：我想不出任何要写的东西。重构框架：我处于错误的写作环境中。'
    },
    {
        id: 're-s-14',
        keyword: '写作',
